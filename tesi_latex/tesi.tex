...
\begin{algorithm}
\caption{Estrazione del contesto latente usando un autoencoder}
 \hspace*{\algorithmicindent} \textbf{Input:} S \\
 \hspace*{\algorithmicindent} \textbf{Output:} O
\begin{algorithmic}[1]
\STATE $y \leftarrow 1$
\IF{$n < 0$}
