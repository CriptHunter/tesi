...
%The increasing computational and sensing capabilities of mobile devices, along with their pervasiveness in our
%daily lives, have contributed to the rapid expansion and evolution of the Internet at its edge. Here, personal mobile
%devices can exploit different wireless technologies to establish device-to-device communication channels among
%them and other smart objects in proximity to autonomously discover new contents available in the environment
%and provide personalized services to the users.
%
%Nowadays we are living surrounded by a plethora of electronic devices that are equipped with a continuously increasing amount of both computational and networking capabilities. In particular, the computational resources of personal
%5 mobile devices (e.g., smartphones, tablets, and wearables) are comparable or
%sometimes exceed those of desktop computers of the past years.
