...
La \autoref{fig:ego-array} mostra la ego network di un utente (in rosso), in cui sono presenti tre alter posizionati rispettivamente nei layer 2, 3 e 4. L'array di valori che rappresenta la ego network in questo caso è 
