...
In letteratura la stragrande maggioranza dei RS proposti si basano su un'architettura client-server. Il RS che esegue sul server ha una conoscenza completa di utenti, oggetti e rating. Il client, fisso o mobile, esegue delle query al RS per ricevere raccomandazioni. I problemi nell'eseguire il RS sul device locale dell'utente sono principalmente due:
\begin{enumerate}
